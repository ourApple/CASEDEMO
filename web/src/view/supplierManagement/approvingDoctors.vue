    ...
    <div class="main_bottom">
      <el-form ref="form" :model="form" label-width="55px">
        <el-row>
          ...
          <el-col :span="5">
            <el-form-item label="医院编码" label-width="80px">
              <el-input v-model="form.coding"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="5">
            <el-form-item label="医院全称" label-width="80px">
              <el-input v-model="form.name"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="5">
            <el-form-item label="主治医师" label-width="80px">
              <el-input v-model="form.doctor"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="4">
            <el-form-item label="个案管理师" label-width="90px">
        ...
        <el-row>
          <el-col :span="24" style="text-align:right; margin-top:5px;">
            ...
            <el-button type="warning">解冻</el-button>
